		...
		<div class="panel-body">
			...
			<div role="tabpanel">
				...
				<ul class="nav nav-tabs" role="tablist">
					<li class="active" role="presentation"><a href="#general" aria-controls="general" role="tab" data-toggle="tab">{{{ trans('mobileinn/people::people/common.tabs.general') }}}</a></li>
					<li role="presentation"><a href="#access" aria-controls="access" role="tab" data-toggle="tab">{{{ trans('mobileinn/people::people/common.tabs.access') }}}</a></li>
				</ul>
				...
				<div class="tab-content">
					...
					@include($viewPrefix.'partial/apartmentcomplex')
